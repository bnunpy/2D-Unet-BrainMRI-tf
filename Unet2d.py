...
def unet2d(pretrained_weights=None):
    inputs = Input((params.IMG_SIZE, params.IMG_SIZE, params.NUM_CHANNELS))
    ...
    conv10 = Conv2D(params.NUM_CLASSES, 1, activation = 'softmax')(conv9)
